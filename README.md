  ...
  <div class="container reveal">
    ...
    <div class="projects-grid">
      <div class="card featured">
        ...
        <img class="card-img" src="att.bEqwfJqsYOZw1XvNHm5ZqKccgYlZjJOf7Gew10GEFW0.jpg" alt="Presenting the VEX Clawbot to the President of KAUST">
      </div>
      <div class="card">
      ...
      <div class="card">
        ...
        <img class="card-img" src="data:image/jpeg;base64,(TRUNCATED FOR LENGTH)" alt="Cardboard Cereal Dispenser">
      </div>
    </div>
  </div>
</section>
...
<section id="contact">
  <div class="container reveal">
    ...
    <div class="contact-box">
      <p>I'm always looking for new projects, robotics competitions, and collaborative ideas.</p>
      <a href="mailto:adam.m.elhoseiny@gmail.com" class="btn">Say Hello</a>
    </div>
  </div>
</section>
...
<footer>
  <div class="container">
    <p>© 2026 Adam Elhoseiny. Built with HTML & CSS.</p>
  </div>
</footer>
