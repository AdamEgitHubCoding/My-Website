...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .card-image {
    ...
    border-radius: 10px; margin: 4px 0 16px;
    box-shadow: 0 8px 24px rgba(31,78,121,0.12);
  }
  .card-image-caption {
    display: block; font-size: 0.82rem; color: var(--light-gray);
    margin-top: -8px; margin-bottom: 14px; font-style: italic;
  }
  .card-image-caption a { color: var(--accent); text-decoration: none; }
  .card-image-caption a:hover { text-decoration: underline; }
  ...
  <div class="container reveal">
    ...
    <div class="projects-grid">
      <div class="card featured">
        ...
        <img src="clawbot-president.jpg" alt="Adam presenting the Clawbot to KAUST President Sir Edward Byrne AC at the launch of the KAUST Robotics Bay" class="card-image">
        <span class="card-image-caption">Presenting the Clawbot to KAUST President Sir Edward Byrne AC at the launch of the <a href="https://www.kaust.edu.sa/en/news/kausts-new-robotics-bay-advances-the-kingdoms-robotics-and-ai-capabilities" target="_blank" rel="noopener">KAUST Robotics Bay</a> — October 13, 2025.</span>
        <p>Built and modified a VEX Clawbot to autonomously identify and pick up objects by color.
        On October 13, 2025, I presented it to <span class="prize">KAUST President Sir Edward Byrne AC</span>
        at the official launch of the KAUST Robotics Bay, and was <span class="prize">featured on Madinah news</span>.
        I also presented the project to the KAUST Robotics Club at its launch.</p>
      </div>
      <div class="card">
